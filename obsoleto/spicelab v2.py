...
# %%
import platform
get_ipython().run_line_magic('alias', 'lts /Applications/LTspice.app/Contents/MacOS/LTspice -ascii -b')
if platform.system() == "Windows":
    get_ipython().run_line_magic('alias', 'lts C:\\Program Files\\LTC\\LTspiceXVII\\XVIIx64.exe -ascii -b')
...
# %%
get_ipython().run_cell_magic('writefile', '"circuito sencillo.net"', '* Este es un circuito sencillo adaptado para LTspice\nr1 1 0 100\nv1 0 1 9\n.op\n* Comentamos el análisis .dc para centrarnos primero en el .op\n* .dc v1 1 10 \n.end')
...
# %%
get_ipython().run_cell_magic('writefile', '"circuito sencillo.raw"', '')
...
# %%
get_ipython().run_cell_magic('writefile', '"carrera en condensadores.ckt"', '* Carga condensador\nv0 0 1 type=vdc vdc=10\nr1 0 2 3k\nc1 2 3 47u ic=0\nv1dummy 3 1 type=vdc vdc=0\nc2 2 4 22u ic=0\nv2dummy 4 1 type=vdc vdc=0\n.tran tstep=0.01 tstart=6.5 tstop=7.5 uic=0\n.end')
...
# %%
get_ipython().run_cell_magic('writefile', '"corriente alterna.net"', '* Circuito en corriente alterna\nv1 1 0 sin(0 120 60 0 0)\nr1 0 1 10k\n.tran 1\n.end')
